 ...
 * 
 */
@WebServiceClient(name = "CalculatorServiceService", targetNamespace = "http://soap.example.com/", wsdlLocation = "http://localhost:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICESERVICE_QNAME = new QName("http://soap.example.com/", "CalculatorServiceService");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://soap.example.com/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.example.com/", "CalculatorServicePort"), CalculatorService.class, features);
    }
